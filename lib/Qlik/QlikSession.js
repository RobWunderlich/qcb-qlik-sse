...
var getSession = function (commonHeader) {
	const traceSocket = false; /* 12.03.2022 was true; reduce logging as now everything seems to work rva@heldendaten.net */
	...
	const config = {
		schema,
			...
			suspendOnClose: true, /* 18.01.2022 das war true rva@heldendaten.net*/
	}
