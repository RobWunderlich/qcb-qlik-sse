...
Returns **[string][64]** status - "Created" or "Replaced" plus any validation error messages.
...
-   `props` **[string][64]** MeasureProps in JSON format
...
-   `ciphertext` **[string][64]** to decrypt, as generated by the Encrypt() function.
-   `passphrase` **[string][64]** to decrypt with.  This must be the same passphrase that was used in Encrypt().
...
Returns **[string][64]** unencrypted text.
...
Returns **[string][64]** status - "Deleted" plus any validation error messages.
...
-   `plaintext` **[string][64]** to encrypt.
-   `passphrase` **[string][64]** to encrpyt with.
...
Returns **[string][64]** encrypted text.
...
-   `htmlString` **[string][64]** 

Returns **[string][64]** text - The text value, which should be the HTML string minus tag elements.
...
Returns **[string][64]** json Dimension(s)
...
Returns **[string][64]** json Measure(s)
...
-   `stringToTest` **[string][64]** The string to test with the regular expression.
-   `pattern` **[string][64]** The regular expression pattern to use in the test.

Returns **[number][65]** boolean - 0 if false, -1 if true.
...
-   `fromAddress` **[string][64]** 
-   `toAddress` **[string][64]** 
-   `subject` **[string][64]** 
-   `text` **[string][64]** text version of message
-   `html` **[string][64]** html version of message. Empty string if no html version.
